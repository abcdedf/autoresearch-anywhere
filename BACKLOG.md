...
- [ ] **Cost budget enforcement end-to-end**: The budget watchdog (30s interval) and per-experiment timeout (TIME_BUDGET × 3) are implemented but not yet validated on a real cloud run. Verify:
